...
hi Comment ctermfg=61 ctermbg=NONE cterm=NONE guifg=#ffddff guibg=NONE gui=NONE
...
hi Todo ctermfg=61 ctermbg=NONE cterm=inverse,bold guifg=#ffddff guibg=NONE gui=inverse,bold
